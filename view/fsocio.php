...
<body>
  ...
  <div class="menu-container">
    <ul class="menu">
	     ...
	     <li><a href="fregistrosocio.php">Registrar Socio</a></li>
	     <li><a href="listar_socios.php">Listar Socios</a></li>
		 	   <li><a href="factualizacion.php">Modificar Datos Socio</a></li>
	  <li><a href="fEliminarSocio.php">Eliminar Socio</a></li>
