...
<body>
  ...
  <div class="menu-container">
    <ul class="menu">
	    ...
	    <li><a href="fregistrolibro.php">Registrar Libro</a></li>
	   	       <li><a href="fbusquedalibro.php">Buscar Libro</a></li>
    ...
    <li><a href="fbuscar_libro.php">Actualizar Datos Libro</a></li>
   <li><a href="fEliminarLibro.php">Eliminar Libro</a></li>
...
<body>
    ...
    <!-- The navigation menu -->
    <ul>
        <li><a href="fportadas.php" class="green-button">Portada Libros</a></li>
    </ul>
