...
<body>
  ...
  <form method="POST" action="../controller/devolucion.php">
...
<div class="form-group">
  ...
  <input type="text" id="ci" name="ci" maxlength="8" required>
   	...
   	<div class="form-group">
		...
		<input type="date" id="fecha_devolucion" name="fecha_devolucion" value="<?php echo date('Y-m-d'); ?>" pattern="\d{4}/\d{2}/\d{2}" placeholder="yyyy/mm/dd" required>
	</div>
